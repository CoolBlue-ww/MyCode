...
Usage - Single-GPU training:
    $ python load_test.py --data coco128.yaml --weights yolov5s.pt --img 640  # from pretrained (recommended)
    $ python load_test.py --data coco128.yaml --weights '' --cfg yolov5s.yaml --img 640  # from scratch

Usage - Multi-GPU DDP training:
    $ python -m torch.distributed.run --nproc_per_node 4 --master_port 1 load_test.py --data coco128.yaml --weights yolov5s.pt --img 640 --device 0,1,2,3
...
def train(hyp, opt, device, callbacks):
    ...
    Example:
        ...
        ```bash
        $ python -m torch.distributed.run --nproc_per_node 4 --master_port 1 load_test.py --data coco128.yaml --weights
...
def main(opt, callbacks=Callbacks()):
    ...
    # Evolve hyperparameters (optional)
        ...
        LOGGER.info(
            ...
            f"Usage example: $ python load_test.py --hyp {evolve_yaml}"
        )
